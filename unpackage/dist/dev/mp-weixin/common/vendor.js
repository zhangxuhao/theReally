...
var _config = __webpack_require__(/*! ./config */ 15);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

//过滤图片地址，如果不是网络地址则拼接域名
_vue.default.filter('img', function (value) {
  var url = _config.IS_DEV ? _config.DEV_URL : _config.PRO_URL;
...
//格式化阅读数量
_vue.default.filter('view', function (value) {
  if (value != undefined && value != null) {
    if (value >= 10000) {
...
//格式化金额
_vue.default.filter('price', function (value) {
  if (value != undefined && value != null) {
    if (value >= 10000) {
...
//大写转小写数字
_vue.default.filter('number', function (value) {
  if (value != undefined && value != null) {
    var result = 0;
    switch (value) {
...
//计算多久之前
_vue.default.filter('datestr', function (d) {
  var date = new Date(d);
  var now = new Date();
  var dt = now - date;
  var s = dt / 1000;
...
_vue.default.filter('idcard', function (value) {
  if (!value) {
    return '';
  } else {
    var data = value.replace(/(\d{8})\d{8}(\d*)/, '$1********$2');
    return data;
  }
});

// 手机号脱敏('13912345678' 转换成 '139****5678') 第3位开始替换4个
_vue.default.filter('telHide', function (value) {
  if (!value) {
    return '';
  } else {
    var data = value.replace(/(\d{3})\d{4}(\d*)/, '$1****$2');
    return data;
  }
});

// 姓名脱敏(小明 转换成 *明   李小明 转换成 李*明   欧阳小明 转换成 欧**明)
_vue.default.filter('nameHide', function (value) {
  if (!value) {
    return '';
  } else {
    if (value.length === 2) {
...
//格式化银行卡号，4位放一个空格
_vue.default.filter('formataccNo', function (accNo) {
  var result = '',
  index = 0;
...
// 银行卡脱敏
_vue.default.filter('bankCardHide', function (value) {
  if (!value) {return;}
  if (value) {
    var reg = /^(\d{4})\d+(\d{4})$/;
    var _str = '*';
    var _len = value.length - 8;
    if (_len > 1 && _len < 16) {
      for (var i = 0; i < _len; i++) {
        _str = _str + '*';
      }
      console.log(_str);
      var _num = value.replace(reg, "$1".concat(_str, "$2"));
      return _num;
    } else {
      var _num2 = value.replace(reg, "$1****$2");
      return _num2;
    }
  }
});
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default =
{
  ...
  /*
      ...
      * @param endTime 结束时间
      */
  intervalTime: function intervalTime(beginTime, endTime) {
    var start = beginTime;
    var end = endTime;
  ...
  /**
      ...
      * @returns {boolean}
      */
  isAlphabets: function isAlphabets(str) {
    var reg = /^[A-Za-z]+$/;
    return reg.test(str);
  },
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _config = _interopRequireDefault(__webpack_require__(/*! ./config.js */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var install = function install(Vue, vm) {
  ...
  uni.$u.http.setConfig(function (config) {
    // 域名设置
    config.baseURL = _config.default.IS_DEV ? _config.default.DEV_URL : _config.default.PRO_URL;
    ...
    config.custom = {
      ...
      LoadingMask: true,
      // Loading文本
      LoadingText: _config.default.LOADING_TEXT };
    // 全局自定义参数默认值

    config.timeout = _config.default.TIMEOUT;
    ...
    config.validateStatus = function (statusCode) {// statusCode 必存在。此处示例为全局默认配置
  ...
  uni.$u.http.interceptors.request.use(function (config) {
    ...
    //是否开启请求日志
    if (_config.default.REQUEST_LOG) {
      _reqlog(config);
    }
    // 最后需要将config进行return
    return config;
...
{
  config: {
    baseURL: _config.default.IS_DEV ? _config.default.DEV_URL : _config.default.PRO_URL,
  ...
  request: function request(options) {
    console.log('uni');
    //请求前处理，相当于请求拦截
    var config = Object.assign(this.config, options); //合并全局配置及局部配置项
    //加载提示
    if (config.custom.ShowLoading) {
      uni.showLoading({
        title: config.custom.LoadingText || '正在加载',
    ...
    return new Promise(function (resolve, reject) {
      uni.request(config).then(function (data) {
        // data为一个数组
        // 数组第一项为错误信息 即为 fail 回调
        // 第二项为返回数据
        var _data = _slicedToArray(data, 2),err = _data[0],res = _data[1];
...
/**
        ...
        */
//请求日志
exports.default = _default;function _reqlog(req) {
...
/* 160 */
/*!***********************************************************************************************************!*\
  !*** G:/myProject/识别狠活小程序/code/theReally/uni_modules/lime-clipper/components/l-clipper/images/rotate.svg ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 161 */
/*!**********************************************************************************************************!*\
  !*** G:/myProject/识别狠活小程序/code/theReally/uni_modules/lime-clipper/components/l-clipper/images/photo.svg ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 162 */
/*!**************************************************************************************************!*\
  !*** G:/myProject/识别狠活小程序/code/theReally/uni_modules/lime-clipper/components/l-clipper/utils.js ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function calcImageSize(width, height, data) {
  ...
  var cw = clipWidth || originWidth;
  var ch = clipHeight || originHeight;
